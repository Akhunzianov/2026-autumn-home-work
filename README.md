...
* Не используйте большие языковые модели (LLM) и аналогичные инструменты для написания кода.
...
* Задание, в котором тесты или иные проверки не пройдены, не оценивается. Ответственность за успешное прохождение всех проверок в pull request лежит на студенте.
...
Цель оценки — объективно проверить решение. Снижение баллов допускается только при наличии обоснованных оснований.
